...
feedConfiguration = FeedConfiguration
    { feedTitle       = "Da RSS feed"
    , feedDescription = "Most Powerful Thing in The World, RSS"
    , feedAuthorName  = "Bavid Dowie"
    , feedAuthorEmail = "nicholai@outlook.com"
    , feedRoot        = "http://hibiscusbiscuit.github.io/blog"
    }
